...
namespace ProjekatGNS.Model
{
    public class RegistrovaniKorisnik
    {
        ...
        private ECiljKlijenta _ciljKlijenta;

        public ECiljKlijenta CiljKlijenta
        {
        ...
        {
            return Ime + ";" + Prezime + ";" + Email + ";" + Telefon + ";" + Adresa + ";" + BrKartice + ";" + OsnovniJezik + ";" + DodatniJezik + ";" + TipKorisnika + ";" + Lozinka + ";" + CiljKlijenta + ";" + Aktivan;
        }
        ...
        public RegistrovaniKorisnik Clone()
        {
            ...
            kopija.CiljKlijenta = CiljKlijenta;
